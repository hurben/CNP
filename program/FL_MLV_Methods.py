...
########################################################################
				gene_without_FC = REMOVE_FC(gene)
				gene_condition_dict[gene_without_FC] = condition
########################################################################
	...
	return condition_dict, gene_list, gene_condition_dict
